setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/BaronPancreas_mouse")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/BaronPancreas_mouse/BaronPancreas_mouse_data.rds')
